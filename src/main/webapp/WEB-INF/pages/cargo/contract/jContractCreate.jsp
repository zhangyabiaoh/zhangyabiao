    ...
    <div>
		<table class="commonTable" cellspacing="1">
	        <tr>
	            ...
	            <td class="tableContent"><input type="text" name="customer"/></td>
	            <td class="columnTitle_mustbe">收购方：</td>
	            <td class="tableContent"><input type="text" name="c_offer" value="大连商贸有限公司"/></td>
	        </tr>
	        <tr>
	            <td class="columnTitle_mustbe">合同号：</td>
	            <td class="tableContent"><input type="text" name="contract_num"/></td>
	        ...
	        <tr>
	            ...
	            <td class="tableContent">
					<input type="text" style="width:90px;" name="sign_date"
	             			onclick="WdatePicker({el:this,isShowOthers:true,dateFmt:'yyyy-MM-dd'});"/>
				</td>
	            <td class="columnTitle_mustbe">重要程度：</td>
	            <td class="tableContentAuto">
	            	<input type="radio" name="importance_num" value="3" class="input" checked>★★★
	            	<input type="radio" name="importance_num" value="2" class="input">★★
	            	<input type="radio" name="importance_num" value="1" class="input">★
	            </td>
	        </tr>
	        <tr>
	            <td class="columnTitle_mustbe">交货期限：</td>
	            <td class="tableContent">
					<input type="text" style="width:90px;" name="delivery_date"
	             			onclick="WdatePicker({el:this,isShowOthers:true,dateFmt:'yyyy-MM-dd'});"/>
				</td>
	            <td class="columnTitle_mustbe">船期：</td>
	            <td class="tableContent">
					<input type="text" style="width:90px;" name="ship_date"
	             			onclick="WdatePicker({el:this,isShowOthers:true,dateFmt:'yyyy-MM-dd'});"/>
				</td>
	        </tr>
	        <tr>
	        ...
	        <tr>
	            ...
	            <td class="tableContent"><input type="text" name="cinput_by"/></td>
	            <td class="columnTitle_mustbe">审单人：</td>
	            <td class="tableContent"><input type="text" name="checked_by"/></td>
	        </tr>
	        <tr>
	            ...
	            <td class="tableContent"><textarea name="crequests" style="height:120px;"></textarea></td>
	        </tr>
		</table>
	</div>
</div>
