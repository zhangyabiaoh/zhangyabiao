...
<div> 
						...
						<div class="listTablew">
							<table class="commonTable_main" cellSpacing="1" id="mRecordTable">
								...
								<%--  <tr>
								    <td class="tableContent"><input type="text" name="shipmentPort" value="${obj.mr_grossWeight}"/></td>
								   <td class="tableContent"><input type="text" name="shipmentPort" value="${obj.mr_grossWeight}"/></td>
						            <td class="tableContent"><input type="text" name=mr_grossWeight value="${mr_grossWeight}"/></td>              
						            <td class="tableContent"><input type="text" name="mr_netWeight" value="${mr_netWeight}"/></td>
						            <td class="tableContent"><input type="text" name="mr_sizeLength" value="${mr_sizeLength}"/></td>
						            <td class="tableContent"><input type="text" name="mr_sizeWidth" value="${mr_sizeWidth}"/></td>
						            <td class="tableContent"><input type="text" name="mr_sizeHeight" value="${mr_sizeHeight}"/></td>
						            <td class="tableContent"><input type="text" name="mr_exPrice" value="${mr_exPrice}"/></td>
						            <td class="tableContent"><input type="text" name="mr_tax" value="${mr_tax}"/></td> 
	    					   </tr> --%>
							</table>
						</div>
